...
3. **Configure the application**:
   ...
   - Example configuration documentation can be found in the [Configuration Docs](docs/04_configuration.md).
...
1. [The Domain Layer (`docs/01_domain.md`)](docs/01_domain.md) - Core models, rules, and business logic.
2. [The Application Layer (`docs/02_application.md`)](docs/02_application.md) - Orchestration, use cases, and system sequence.
3. [The Infrastructure Layer (`docs/03_infrastructure.md`)](docs/03_infrastructure.md) - Concrete adapters and implementation details.
4. [Configuration Reference (`docs/04_configuration.md`)](docs/04_configuration.md) - Guide for `config.json`.
